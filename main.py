...
# from client import *
from client_cgo import Client
from client_cgo import *
from server import *
from myModel import *
...
if __name__ == "__main__":
    ...
    # 一次性将10个客户端的数据分好
    data_set, taskcla_list = cf100.get2(seed=args.seed, pc_valid=args.pc_valid, clients_num=args.clients_num, task_num=args.task_num)
